...
from glycoml.phase1.pipeline.thera_sabdab_pipeline import (  # noqa: E402
    ChainData,
...
# Load models.structure_ranker directly from its file path to avoid pulling in
# the package __init__ (which may import torch-dependent siblings).
_sr_path = PHASE1_ROOT / "models" / "structure_ranker.py"
...
def test_resolve_uniprot_ids_query_has_database_name_filter(monkeypatch):
    ...
    import glycoml.phase1.pipeline.thera_sabdab_pipeline as pipeline_mod
