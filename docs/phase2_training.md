...
```bash
python -m glycoml.phase2.train       --data-path data/glycoml_phase2_unified_lectin_glycan_interactions.csv       --unilectin-path data/unilectin3d_lectin_glycan_interactions.csv       --cfg-metadata-path data/cfg_experiment_metadata.csv       --ligands-path data/unilectin3d_ligands.csv       --output-dir outputs/phase2_model       --label-mode multi       --glycan-encoder graph       --use-structure       --seed 42
```
...
```bash
python -m glycoml.phase2.baselines       --data-path data/glycoml_phase2_unified_lectin_glycan_interactions.csv       --output-dir outputs/phase2_baselines
```
