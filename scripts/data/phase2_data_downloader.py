...
def orchestrate_phase2_data_download(args: argparse.Namespace) -> None:
    ...
    cache_dir = output_dir / "cache" / "requests"
    for folder in (raw_dir, processed_dir, interim_dir, metadata_dir, cache_dir):
        ensure_dir(folder)
    ...
    unilectin_output = interim_dir / "unilectin3d_lectin_glycan_interactions.csv"
    predicted_output = metadata_dir / "unilectin3d_predicted_lectins.csv"
    ligand_output = metadata_dir / "unilectin3d_ligands.csv"
    ...
    cfg_metadata_path = metadata_dir / "cfg_experiment_metadata.csv"
    ...
    cfg_raw_dir = raw_dir / "cfg_arrays_raw"
    ...
    cfg_rfu_output = processed_dir / "cfg_rfu_measurements.csv"
